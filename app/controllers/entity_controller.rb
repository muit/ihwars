class EntityController < ApplicationController
  def create
    ...
    return if watchError opcode, !hasFactories?, "Can´t create entities without factories!"

    return if watchError opcode, is_entity_size_exceded?(amount, base), "Not enought space in the base. Build houses!"
